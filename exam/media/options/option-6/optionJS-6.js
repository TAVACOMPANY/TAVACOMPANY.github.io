...
const questions = [
    ...
    {
        question: 'В Алматы 16 февраля 1993 г. открылось представительство? ',
        options: [
            'НАТО',
            'ООН',
            'ШОС',
    ...
    {
        question: '6 июля 1998 года подписана Декларация между Республикой Казахстан и Российской Федерацией? ',
        options: [
    ...
    {
        question: '25 февраля - 4 марта 1999 г. проведено мероприятие? ',
        options: [
