...
const questions = [
    ...
    {
        question: 'Какое значение получит переменная k при выполнении следующих команд:' + br + 'k = 1;' + br + 'for (i = 3; i >= 0; i--)' + br + 'k--;',
        options: [
            '–0',
            '–6',
            '–5',
    ...
    {
        question: 'Какое значение получит переменная k при выполнении следующих команд:' + br + 'k = 0; i =1;' + br + 'while (i <= 5)' + br + '{k--; i++}',
        options: [
            '1',
            '4',
            '–1',
    ...
    {
        question: 'Какое значение получит переменная k при выполнении следующих команд:' + br + 'k = 0; i =1;' + br + 'while (i < = 3)' + br + '{k++; i++;}',
        options: [
            '5',
            '9',
            '6',
    ...
    {
        question: 'Какое значение получит переменная k при выполнении следующих команд:' + br + 'k = 0; i=1;' + br + 'while (i <= 5)' + br + '{k + = i; i + +;}',
        options: [
            '10',
            '20',
            '15',
