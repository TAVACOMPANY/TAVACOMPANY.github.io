...
const questions = [
    {
        question: 'Какое значение получит переменная k при выполнении следующих команд:' + br + 'k = 0;' + br + 'for (i = 1; i <= 3; i++)' + br + 'k + =i+3;',
        options: [
            '14',
            '15',
            '13',
    ...
    {
        question: 'Какое значение получит переменная k при выполнении следующих команд:' + br + 'k = 0;' + br + 'for (i = 3; i >= 0; i--)' + br + 'k += i;',
        options: [
            '–6',
            '4',
            '–3',
